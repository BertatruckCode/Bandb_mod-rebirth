...
public class BlockCrop extends BlockCrops implements IGrowable
{
    ...
    public BlockCrop(Item item, String str, String render)
    {
    	itemDrop = item;   	
    	texture = str;
    	renderType = render;
    ...
    {
		if (texture == "whitemushroom")
			return BandbCrops.itemSeedWhiteMushroom;
		if (texture == "mint")
			return BandbCrops.itemSeedMint;
		if (texture == "mustard")
			return BandbCrops.itemSeedMustard;
		if (texture == "poppy")
			return BandbCrops.itemSeedPoppy;
		if (texture == "cotton")
			return BandbCrops.itemSeedCotton;
		if (texture == "basil")
			return BandbCrops.itemSeedBasil;
		if (texture == "agave")
			return BandbCrops.itemSeedAgave;
		if (texture == "cardamom")
			return BandbCrops.itemSeedCardamom;
		if (texture == "hibiscus")
			return BandbCrops.itemSeedHibiscus;
		if (texture == "jasmine")
			return BandbCrops.itemSeedJasmine;
		if (texture == "lavender")
			return BandbCrops.itemSeedLavender;
		if (texture == "ender")
			return BandbCrops.itemSeedEnder;
		if (texture == "blowball")
			return BandbCrops.itemSeedBlowball;
		if (texture == "buttercup")
			return BandbCrops.itemSeedButtercup;
		if (texture == "rosmary")
			return BandbCrops.itemSeedRosmary;
		if (texture == "tarragon")
			return BandbCrops.itemSeedTarragon;
		if (texture == "amaryllispink")
			return BandbCrops.itemSeedAmaryllisPink;
		if (texture == "amaryllisred")
			return BandbCrops.itemSeedAmaryllisRed;
		if (texture == "amarylliswhite")
			return BandbCrops.itemSeedAmaryllisWhite;
		if (texture == "bachelorsbuttonblue")
			return BandbCrops.itemSeedBachelorsButtonBlue;
		if (texture == "belladonna")
			return BandbCrops.itemSeedBelladonna;
		if (texture == "bettercactus")
			return BandbCrops.itemSeedBetterCactus;
		if (texture == "callablack")
			return BandbCrops.itemSeedCallaBlack;
		if (texture == "callawhite")
			return BandbCrops.itemSeedCallaWhite;
		if (texture == "cannabis")
			return BandbCrops.itemSeedCannabis;
		if (texture == "chrysantheme")
			return BandbCrops.itemSeedChrysantheme;
		if (texture == "coca")
			return BandbCrops.itemSeedCoca;
		if (texture == "daisy")
			return BandbCrops.itemSeedDaisy;
		if (texture == "enzian")
			return BandbCrops.itemSeedEnzian;
		if (texture == "foxglove")
			return BandbCrops.itemSeedFoxglove;
		if (texture == "heather")
			return BandbCrops.itemSeedHeather;
		if (texture == "irisblue")
			return BandbCrops.itemSeedIrisBlue;
		if (texture == "irispurple")
			return BandbCrops.itemSeedIrisPurple;
		if (texture == "lily")
			return BandbCrops.itemSeedLily;
		if (texture == "marshmarigold")
			return BandbCrops.itemSeedMarshMarigold;
		if (texture == "orchid")
			return BandbCrops.itemSeedOrchid;
		if (texture == "pansy")
			return BandbCrops.itemSeedPansy;
		if (texture == "peony")
			return BandbCrops.itemSeedPeony;
		if (texture == "rape")
			return BandbCrops.itemSeedRape;
		if (texture == "sesame")
			return BandbCrops.itemSeedSesame;
		if (texture == "syringa")
			return BandbCrops.itemSeedSyringa;
		if (texture == "tobacco")
			return BandbCrops.itemSeedTobacco;
		if (texture == "violet")
			return BandbCrops.itemSeedViolet;
