...
public class BlockCropGrapeWhite extends BlockCrops implements IGrowable
{
    ...
    public BlockCropGrapeWhite(Item item, String str)
    {
    	itemDrop = item;
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        ...
        {
            this.iIcon[i] = p_149651_1_.registerIcon(Bandb_mod.MODID + ":crop/grape/blockCropGrapeWhite"  + "_stage" + i);
        }
    }
    ...
    protected Item func_149866_i()
    {
    	...
    	if(texture == "cot")
            return BandbCrops.itemSeedGrapeCot;
