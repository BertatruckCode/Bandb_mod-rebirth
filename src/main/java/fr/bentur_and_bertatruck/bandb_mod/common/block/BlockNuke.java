...
import fr.bentur_and_bertatruck.bandb_mod.entity.EntityNukePrimed;
...
public class BlockNuke extends Block
{
	...
	public void onBlockDestroyedByExplosion(World par1World, int par2, int par3, int par4, Explosion par5Explosion) {
		if (!par1World.isRemote) {
			EntityNukePrimed nukePrimed = new EntityNukePrimed(par1World, (double) ((float) par2 + 0.5F), (double) ((float) par3 + 0.5F), (double) ((float) par4 + 0.5F), par5Explosion.getExplosivePlacedBy());
    ...
    public void primeTnt(World par1World, int par2, int par3, int par4, int par5, EntityLivingBase par6EntityLivingBase) {
        if (!par1World.isRemote) {
            if ((par5 & 1) == 1) {
            	EntityNukePrimed nukePrimed = new EntityNukePrimed(par1World, (double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5F),  par6EntityLivingBase);
                nukePrimed.setFuse(fuse);
                par1World.spawnEntityInWorld(nukePrimed);
