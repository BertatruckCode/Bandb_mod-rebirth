...
public class GuiIngotMasher extends GuiContainer {
	public ResourceLocation texture = new ResourceLocation(Bandb_mod.MODID + ":" + "/textures/gui/IngotMasherGui.png");
	public TileEntityIngotMasher ingotMasher;

	public GuiIngotMasher(InventoryPlayer invPlayer,
			TileEntityIngotMasher teIngotMasher) {
