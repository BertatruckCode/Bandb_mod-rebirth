...
public class GuiLabelMachine extends GuiContainer {

	public static final ResourceLocation bground = new ResourceLocation(Bandb_mod.MODID + ":textures/gui/guiLabelMachine.png");

	public TileEntityLabelMachine tileEntity;

	public GuiLabelMachine(InventoryPlayer inventoryPlayer, TileEntityLabelMachine entity) {
		super(new ContainerLabelMachine(inventoryPlayer, entity));
