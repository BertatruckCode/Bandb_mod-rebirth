...
public class SlotBarrelOakBottle extends Slot{

	public SlotBarrelOakBottle(IInventory inv, int par2, int par3, int par4) {
		...
		public boolean isItemValid(ItemStack itemstack) {
			if(itemstack.getItem() instanceof ItemBottleWin)
		return true;
			else
				return false;
		}
