...
public class TileEntityBarrelOak extends TileEntity implements IInventory {
	...
	public void updateEntity() {
		...
		if (!this.worldObj.isRemote) {
			if (this.workTimeLeft == 0 && this.canSmelt()
					&& this.slots[1] != null) {
				this.currentItemWorkTime = this.workTimeLeft = BandbFuel
						.getFuelValue(this.slots[1].getItem());
				if (this.isBurning()) {
					flag1 = true;
