...
public class TileEntityLabelMachine extends TileEntity implements IInventory{
	...
	public boolean canSmelt() {
		if (this.slots[2] == null) {
			...
			ItemStack itemstack = RecipeLabelMachine.getOutputResult(this.slots[2].getItem(), this.slots[3].getItem());
			if(itemstack == null){
				System.out.println("problem with recipe");
				return false;				
			}
