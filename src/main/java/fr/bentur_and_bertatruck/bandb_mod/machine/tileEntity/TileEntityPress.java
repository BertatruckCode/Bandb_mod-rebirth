...
public class TileEntityPress extends TileEntity implements IInventory{
	...
	public boolean canSmelt() {
		if (this.slots[3] == null) {
			...
			return false;
		} else if (this.slots[3].stackSize < RecipePress.getAmountNeeded(this.slots[3].getItem())) {
			return false;
		}else{
			ItemStack itemstack = RecipePress.getOutputResult(this.slots[3].getItem());
			if(itemstack == null)
				return false;
	...
	public void smeltItem() {
		if (this.canSmelt()) {
			...
			this.slots[3].stackSize -= RecipePress.getAmountNeeded(this.slots[3].getItem());
