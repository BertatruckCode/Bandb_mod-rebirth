...
public class TileEntityCottonCandyMachine extends TileEntity implements IInventory{

	
	private ItemStack[] slots = new ItemStack[4];
	
	public int furnaceSpeed = 1200;
	/**
	...
	public void updateEntity() {
		...
		if (!this.worldObj.isRemote) {
			if (this.workTimeLeft == 0 && this.canSmelt() && this.slots[1] != null) {
				this.currentItemWorkTime = this.workTimeLeft = BandbFuel.getFuelValue(this.slots[1].getItem()) * 5;
				if (this.isBurning()) {
					flag1 = true;
	...
	public boolean canSmelt() {
		if (this.slots[2] == null) {
			...
			ItemStack itemstack = new ItemStack(BandbItems.itemBarba);
