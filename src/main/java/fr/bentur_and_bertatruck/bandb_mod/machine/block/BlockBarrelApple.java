...
public class BlockBarrelApple extends BlockContainer {

	private IIcon frontSide;
	private IIcon topSide;
	private IIcon backSide;

	public BlockBarrelApple() {
	...
	public boolean onBlockActivated(World world, int x, int y, int z,EntityPlayer player, int par6, float par7, float par8, float par9) {
		FMLNetworkHandler.openGui(player, Bandb_mod.instance, BandbMachines.guiIDBarrelApple, world, x, y, z);
		return true;
	}

	public TileEntity createNewTileEntity(World var1, int i) {
		return new TileEntityBarrelApple();
	}
