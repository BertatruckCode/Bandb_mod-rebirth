...
public class BlockSyrupMachine extends BlockContainer {

	private IIcon frontSide;
	private IIcon topSide;

	public BlockSyrupMachine() {
	...
	public boolean onBlockActivated(World world, int x, int y, int z,EntityPlayer player, int par6, float par7, float par8, float par9) {
		FMLNetworkHandler.openGui(player, Bandb_mod.instance, BandbMachines.guiIDSyrupMachine, world, x, y, z);
		return true;
	}

	public TileEntity createNewTileEntity(World var1, int i) {
		return new TileEntitySyrupMachine();
	}
	...
	public void registerBlockIcons(IIconRegister icon) {
		frontSide = icon.registerIcon(Bandb_mod.MODID + ":gui/ingotmasher/IngotMasherSideOff");
		topSide = icon.registerIcon(Bandb_mod.MODID + ":gui/ingotmasher/IngotMasherFrontOff");
	}
