...
public class BlockCottonCandyMachine extends BlockContainer {
	...
	public BlockCottonCandyMachine() {
		super(Material.iron);
	...
	public Item getItemDropped(World world, int x, int y, int z) {
		return Item.getItemFromBlock(BandbMachines.blockCottonCandyMachine);
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if (!world.isRemote) {
			FMLNetworkHandler.openGui(player, Bandb_mod.instance, BandbMachines.guiIDCottonCandyMachine, world, x, y, z);
		}
		return true;
	}

	public TileEntity createNewTileEntity(World world, int i) {
		return new TileEntityCottonCandyMachine();
	}
