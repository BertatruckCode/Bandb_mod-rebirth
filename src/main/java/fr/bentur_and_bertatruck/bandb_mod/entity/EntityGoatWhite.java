...
public class EntityGoatWhite extends EntityAnimal
{
    ...
    public EntityGoatWhite(World world)
    {
        super(world);
    ...
    {
        return Bandb_mod.MODID + ":goat.hurt";
    }
    ...
    public EntityGoatWhite createChild(EntityAgeable p_90011_1_){
        return new EntityGoatWhite(this.worldObj);
    }
}