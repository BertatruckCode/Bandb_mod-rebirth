...
public class EntityCowLaughting extends EntityAnimal
{
    private static final String __OBFID = "CL_00001640";

    public EntityCowLaughting(World p_i1683_1_)
    {
        super(p_i1683_1_);
    ...
    public EntityCowLaughting createChild(EntityAgeable p_90011_1_)
    {
        return new EntityCowLaughting(this.worldObj);
    }
}