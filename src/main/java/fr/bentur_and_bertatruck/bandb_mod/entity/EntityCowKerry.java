...
public class EntityCowKerry extends EntityAnimal
{
    private static final String __OBFID = "CL_00001640";

    public EntityCowKerry(World world)
    {
        super(world);
    ...
    public EntityCowKerry createChild(EntityAgeable p_90011_1_)
    {
        return new EntityCowKerry(this.worldObj);
    }
}