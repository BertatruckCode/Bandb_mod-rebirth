...
public class EntityCowCharolaise extends EntityAnimal
{
    private static final String __OBFID = "CL_00001640";

    public EntityCowCharolaise(World world)
    {
        super(world);
    ...
    public EntityCowCharolaise createChild(EntityAgeable p_90011_1_)
    {
        return new EntityCowCharolaise(this.worldObj);
    }
}