...
public class EntityCowNorwegian extends EntityAnimal
{
    private static final String __OBFID = "CL_00001640";

    public EntityCowNorwegian(World world)
    {
        super(world);
    ...
    public EntityCowNorwegian createChild(EntityAgeable p_90011_1_)
    {
        return new EntityCowNorwegian(this.worldObj);
    }
}