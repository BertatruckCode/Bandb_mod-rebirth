...
public class EntityCowMilka extends EntityAnimal
{
    private static final String __OBFID = "CL_00001640";

    public EntityCowMilka(World world)
    {
        super(world);
    ...
    public EntityCowMilka createChild(EntityAgeable p_90011_1_)
    {
        return new EntityCowMilka(this.worldObj);
    }
}