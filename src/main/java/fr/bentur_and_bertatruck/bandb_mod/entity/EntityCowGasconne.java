...
public class EntityCowGasconne extends EntityAnimal
{
    private static final String __OBFID = "CL_00001640";

    public EntityCowGasconne(World world)
    {
        super(world);
    ...
    public EntityCowGasconne createChild(EntityAgeable p_90011_1_)
    {
        return new EntityCowGasconne(this.worldObj);
    }
}