...
public class EntityCowMontbeliarde extends EntityAnimal
{
    private static final String __OBFID = "CL_00001640";

    public EntityCowMontbeliarde(World world)
    {
        super(world);
    ...
    public EntityCowMontbeliarde createChild(EntityAgeable p_90011_1_)
    {
        return new EntityCowMontbeliarde(this.worldObj);
    }
}