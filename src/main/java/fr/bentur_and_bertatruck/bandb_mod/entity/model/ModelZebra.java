...
public class ModelZebra extends ModelBase
{
    ...
    public void setLivingAnimations(EntityLivingBase entity, float p_78086_2_, float p_78086_3_, float p_78086_4_)
    {
        ...
        float f3 = this.updateHorseRotation(entity.prevRenderYawOffset, entity.renderYawOffset, p_78086_4_);
        float f4 = this.updateHorseRotation(entity.prevRotationYawHead, entity.rotationYawHead, p_78086_4_);
        float f5 = entity.prevRotationPitch + (entity.rotationPitch - entity.prevRotationPitch) * p_78086_4_;
        float f6 = f4 - f3;
        ...
        float f9 = 0.0F;
        float f10 = 1.0F - f9;
        float f11 = entityZebra.func_110201_q(p_78086_4_);
        boolean flag = true;
        boolean flag1 = false;
        boolean flag2 = false;
        float f12 = (float)entity.ticksExisted + p_78086_4_;
